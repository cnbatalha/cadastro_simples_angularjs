		...
		[
				...
				function(Base64, $http, $cookieStore, $rootScope, $timeout) {
					...
					service.Login = function(username, password, callback) {
						...
						/*
						 * Dummy authentication for testing, uses $timeout to
						 * simulate api call
						 *              ----------------------------------------------
						 */
						/*
						 * $timeout(function() { var response = { success :
						 * username === 'temporary' && password === 'temporary' };
						 * if (!response.success) { response.message = 'Username
						 * or password is incorrect'; } callback(response); },
						 * 1000);
						 */
						/*
						...
						/*
						 * $http.post('/cadastro-ajs-server/catequista/login',
						 * 'aa', { headers : { 'Authorization' : 'Basic ' +
